...
export default function SkillBoostTrainer() {
  const [skills, setSkills] = useState([]);
  const [selectedSkill, setSelectedSkill] = useState("MUL_TABLE");
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        padding: "1rem",
        overflowY: "auto",          // ← wichtig für Mobile + Keyboard
        background:
    ...
    >
      ...
      >
          ...
          >
            ...
            <form onSubmit={handleSubmitAnswer}>
              <input
                ...
                onFocus={() => {
                  // Beim Fokus sicherstellen, dass der Aufgabenblock sichtbar ist
                  setTimeout(() => {
        ...
        {exercises.length === 0 && !loading && (
          ...
          >
            Wähle oben eine Übung und tippe auf{" "}
            <strong>„Übung starten“</strong>, um loszulegen 🚀
          </p>
        )}
      </div>
    </div>
